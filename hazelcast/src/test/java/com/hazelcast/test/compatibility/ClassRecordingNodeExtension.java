...
/**
 * Node extension that instantiates a {@link ClassRecordingSerializationService} when asked to create
 * {@link com.hazelcast.spi.serialization.SerializationService} instance.
 */
public class ClassRecordingNodeExtension implements NodeExtension {

    private final NodeExtension nodeExtension;

    public ClassRecordingNodeExtension(NodeExtension nodeExtension) {
    ...
    public InternalSerializationService createSerializationService() {
        ...
        return new ClassRecordingSerializationService(serializationService);
    }
