...
public class AddCacheConfigOperation<T extends CacheConfig> extends Operation implements IdentifiedDataSerializable {

    private T cacheConfig;

    public AddCacheConfigOperation() {
    }

    public AddCacheConfigOperation(T cacheConfig) {
    ...
    public void run()
        ...
        cacheService.putCacheConfigIfAbsent(adaptCacheConfig());
    }
    ...
    private CacheConfig adaptCacheConfig() {
