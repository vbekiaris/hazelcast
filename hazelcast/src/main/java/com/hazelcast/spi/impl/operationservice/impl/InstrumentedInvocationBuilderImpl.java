 ...
 */
class InstrumentedInvocationBuilderImpl extends InvocationBuilder {

    private final Invocation.Context context;

    InstrumentedInvocationBuilderImpl(Invocation.Context context, String serviceName, Operation op, int partitionId) {
        this(context, serviceName, op, partitionId, null);
    }

    InstrumentedInvocationBuilderImpl(Invocation.Context context, String serviceName, Operation op, Address target) {
        this(context, serviceName, op, Operation.GENERIC_PARTITION_ID, target);
    }

    private InstrumentedInvocationBuilderImpl(Invocation.Context context, String serviceName, Operation op,
