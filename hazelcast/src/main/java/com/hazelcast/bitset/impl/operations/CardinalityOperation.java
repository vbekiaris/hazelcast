...
public class CardinalityOperation extends AbstractBitSetOperation {
    ...
    @Override
    public int getId() {
        return BitSetDataSerializerHook.CARDINALITY_OPERATION;
    }

    @Override
    public void run()
            throws Exception {
        response = getContainer().cardinality();
    }
