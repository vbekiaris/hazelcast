...
import com.hazelcast.topic.impl.reliable.ReliableTopicBounceTest;
 ...
 *
 */
public class SmartClientReliableTopicBounceTest
        extends ReliableTopicBounceTest {

    protected BounceMemberRule initializeBounceTest() {
        return BounceMemberRule.with(config())
                               .driverType(CLIENT)
                               .driverCount(10)
                               .driverFactory(new SmartClientDriverFactory())
                               .build();
    }

    public class SmartClientDriverFactory extends ClientDriverFactory {
        @Override
